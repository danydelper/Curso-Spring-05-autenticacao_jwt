...
public class JwtRequestFilter extends OncePerRequestFilter{
    ...
    protected void doFilterInternal( 
        ...
        if (isTokenPresent(autorizationHeader)) {
            token = autorizationHeader.substring(TOKEN_TYPE.length());
    ...
    private boolean isTokenPresent(String autorizationHeader) {
        return autorizationHeader != null && autorizationHeader.startsWith(TOKEN_TYPE);
    }
